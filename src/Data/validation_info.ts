...
export class Zones {
  ...
  isPreyValid(zone: Zone, prey: string): boolean | null {
      ...
      if (zone.preyAnimals !== null) {
          return zone.preyAnimals.some(valid_prey => valid_prey.toLowerCase() === prey);
      }
      return null;
  }
}
...
export const threeZones = new Zones(thuelheim_mountains, forest_of_glime, utgard); 